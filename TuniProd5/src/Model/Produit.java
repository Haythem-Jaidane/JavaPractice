...
public class Produit {
    ...
    public Produit(int identifiant,String libelle,String marque,float prix) throws PrixNegatifException{ 
        if(prix < 0){
            throw new PrixNegatifException("le prix doit etre positive");
        }
        this.identifiant=identifiant;
        this.libelle=libelle;
        this.marque=marque;
